...
export default function BackToTop() {
  ...
  return (
    <motion.button
      whileTap={{ scale: 0.9 }}
      onClick={scrollToTop}
      className={`group fixed bottom-6 left-6 z-50 w-12 h-12 rounded-full bg-text text-bg flex items-center justify-center shadow-lg transition-all duration-500 hover:scale-110 overflow-visible ${
